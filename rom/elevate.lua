...
local function center( text, y )
	screen.write( text, { x = ( screen.width - #text*(screen.font.width+1) ) / 2, y = y, colour = "gray-1" } )
end
...
screen.write( fn, { x = 10, y = 60, colour = "black", overflow = "wrap", max = screen.charWidth-3 } )
